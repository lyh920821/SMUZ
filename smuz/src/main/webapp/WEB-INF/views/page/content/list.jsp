      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              <li class="active"><a href="${path}/sub4-1.do"><i class="fa fa-circle-o"></i> 리스트 게시물 관리</a></li>
          ...
          <div class="col-xs-12">
            <div class="box">
              <div class="box-header">
                <h3 class="box-title">리스트 피드 목록</h3>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <c:forEach var="data" items="${data}">
                    <tr>
                      <td>LF${data.lf_id}</td>
                      <td>${data.lf_list}</td>
                      <td>${data.lf_hashtag }</td>
                      <td>user${data.lf_uploader}</td>
                      <td><span class="label" style="background:rgb(${data.lf_color_R},${data.lf_color_G},${data.lf_color_B}); font-size:10.5pt">${data.lf_color_R},${data.lf_color_G},${data.lf_color_B}</span></td>
                      <td>${data.lf_date}</td>
					  <td><a href="${path}/member/lidel.do?uid=${data.lf_id}">리스트 삭제</a></td>
                    </tr>
                    </c:forEach>
                  </tbody>
                  <tfoot>
