...
<div class="wrapper">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="${path}/sub2-2.do"><i class="fa fa-circle-o"></i> 아티스트 관리</a></li>
            </ul>
          </li>
          <li class="treeview">
            <a href="${path}/sub3.do">
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <h1>
          회원 관리
          <small>아티스트 총 ${artistCount} 명</small>
        </h1>
      </section>
          ...
          <div class="col-xs-12">
            <div class="box">
              <div class="box-header">
                <h3 class="box-title">아티스트 정보 관리</h3>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <c:forEach var="artist" items="${artist}">
                    <tr>
                      <td>user${artist.sm_seq}</a></td>
                      <td>${artist.sm_id}</td>
                      <td>${artist.sm_name}</td>
                      <td>${artist.auth}</td>
                      <td>
                        <span class="label" style="background:rgb(${artist.sm_user_r},${artist.sm_user_g},${artist.sm_user_b}); font-size:10.5pt;">${artist.sm_user_r},${artist.sm_user_g},${artist.sm_user_b}</span>
                      </td>
                      <td>${artist.sm_date}</td>
                      <td>
                      <a href="${path}/member/aauth.do?uid=${artist.sm_seq}&auth=${artist.sm_rating}">권한 부여</a> | 
                      <a href="${path}/member/aauthd.do?uid=${artist.sm_seq}&auth=${artist.sm_rating}">권한 삭제</a>
                      </td>
                      <td>
                      <a href="${path}/member/aremove.do?uid=${artist.sm_seq}">회원 삭제</a>
                      </td>
                    </tr>
                   </c:forEach>
                  </tbody>
