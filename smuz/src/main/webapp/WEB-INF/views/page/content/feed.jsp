        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="${path}/sub4-2.do"><i class="fa fa-circle-o"></i> 피드 게시물 관리</a></li>
            </ul>
          </li>
        </ul>
      </section>
              ...
              <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <c:forEach var="data" items="${data}">
                    <tr>
                      <td>MF${data.mf_id}</td>
                      <td>music${data.mf_file}</td>
                      <td>${data.mf_tag}</td>
                      <td>${data.mf_board}</td>
                      <td>user${data.mf_user}</td>
                      <td>${data.mf_date}</td>
					  <td>
					  	<a href="${path}/member/fremove.do?uid=${data.mf_id}">게시물 삭제</a>
					  </td>
                    </tr>
                    </c:forEach>
                  </tbody>
